...
Instructions for setting up KuCoin API.

## Referral

If you are new to KuCoin, and register your account using my referral link.
...
1.  Go to https://www.kucoin.com and log in.
2.  Ensure:
    -   2FA is enabled (Google Authenticator / SMS)
    -   Identity verification is complete
3.  Click profile icon (top right) → **Security** → **API Management**
4.  Click **Create API**
...
KuCoin Testnet simulates trading using virtual funds.

### Steps:

1.  Go to https://demo.kucoin.com
