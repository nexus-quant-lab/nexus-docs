...
Instructions for setting up Bitget API.

## Referral

If you are new to Bitget, and register your account using my referral link.
...
1.  Go to https://www.bitget.com and log in.
2.  Ensure:
...
Bitget Testnet simulates trading using virtual funds.
