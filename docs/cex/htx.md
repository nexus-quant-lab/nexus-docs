...
Instructions for setting up HTX API.

## Referral

If you are new to HTX, and register your account using my referral link.
...
1.  Go to https://www.htx.com and log in.
2.  Ensure:
...
HTX Testnet simulates trading using virtual funds.

### Steps:

1.  Go to https://testnet.htx.com
