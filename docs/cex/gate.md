...
Instructions for setting up Gate API.

## Referral

If you are new to Gate, and register your account using my referral link.
...
1.  Go to https://www.gate.io and log in.
2.  Ensure:
...
Gate Testnet simulates trading using virtual funds.

### Steps:

1.  Go to https://testnet.gateio.dev
