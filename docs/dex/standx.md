...
Instructions for setting up dYdX perpetual DEX.

## Referral

If you are new to dYdX, and register your account using my referral link.
...
dYdX is a decentralized exchange for trading perpetual contracts.
...
Generate API keys from the dYdX interface for programmatic trading.
...
-   dYdX does not offer a public testnet for API trading.
